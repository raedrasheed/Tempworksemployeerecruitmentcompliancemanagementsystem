# Phase 2.16 — Finance Scope Split
...
| Mutation paths (`create`, `update`, `remove`, `updateStatus`, `addDeduction`, `removeDeduction`, `addAttachment`, `removeAttachment`) | 2.17+ | NO |
...
## 3. Phase 2.17+ — Mutation refactor (FUTURE)
