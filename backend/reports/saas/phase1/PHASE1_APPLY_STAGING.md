...
|-------|--------|------|----------|
| preflight | OK | 3 | 17698 ms |
| recon-A-user-identity | OK | 0 | 2138 ms |
| recon-B-agency-tenant-projection | OK | 0 | 2211 ms |
| recon-C-unique-constraints | OK | 0 | 2181 ms |
| recon-D-data-ownership | OK | 0 | 2262 ms |
| recon-E-reports-sql | OK | 0 | 2229 ms |
| tenant-backfill | OK | 0 | 2322 ms |
| seq-snapshot | OK | 0 | 2179 ms |
| verify | OK | 0 | 2228 ms |
