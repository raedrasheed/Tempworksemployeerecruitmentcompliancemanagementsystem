...
- PASS — 2. dry-run reports correct candidate count — candidate=1
...
- PASS — 5. apply updates only AttendanceRecord rows with matching ar.tenantId — mode=apply updated=1 candidate=1
