...
Generated: 2026-05-10T16:37:12.903Z
...
| 5 | getDashboard: legacy totalAlerts ≥ pilot totalAlerts (pilot filtered) | PASS | legacy=10 pilot=3 |
| 6 | getDashboard: pilot summary excludes NULL-tenant + tenant B | PASS | pilot.totalAlerts=3 (expected 3 for tenant A) |
| 7 | getAlerts: pilot total < legacy total (other tenants filtered) | PASS | legacy=10 pilot=3 |
| 8 | getAlerts(status=OPEN): both modes count only OPEN status | PASS | legacy open=8/10 pilot open=2/3 |
