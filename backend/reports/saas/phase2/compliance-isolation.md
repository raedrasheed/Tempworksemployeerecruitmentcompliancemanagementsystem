...
Generated: 2026-05-10T13:50:54.758Z
...
| 6 | pilot OFF: legacy reads include tenant B + NULL-tenant legacy row | PASS | total=8 includesB=true includesNull=true |
| 7 | allow-list: TENANT_PRISMA_PILOT_MODULES=nothing ⇒ legacy union (compliance opt-out) | PASS | total=8 includesB=true |