...
Generated: 2026-05-10T15:48:35.141Z
...
| 5 | concurrent ALS frames isolated (T_A no B-rows; T_B no A-rows) | PASS | seenA=3 ids; seenB=4 ids; bNoA=true |
| 6 | pilot OFF: legacy reads include tenant B + NULL-tenant legacy row | PASS | total=10 includesB=true includesNull=true |
| 7 | allow-list: TENANT_PRISMA_PILOT_MODULES=nothing ⇒ legacy union (compliance opt-out) | PASS | total=10 includesB=true |