...
Generated: 2026-05-09T19:06:00.409Z
...
| # | Case | Result | Detail |
|--:|------|:------:|--------|
| 1 | pilot ON, tenant A: getAlerts returns ONLY tenant A rows | PASS | ids=00000000-0000-0000-0000-00000000c001,00000000-0000-0000-0000-00000000a004,00000000-0000-0000-0000-00000000a005 |
| 2 | pilot ON, tenant A: getDashboard.summary.totalAlerts excludes other tenants | PASS | totalAlerts=3 (expected 3) |
| 3 | pilot ON, tenant A: dashboard recentAlerts contain no tenant B ids | PASS | recentIds=00000000-0000-0000-0000-00000000c001,00000000-0000-0000-0000-00000000a004,00000000-0000-0000-0000-00000000a005 |
