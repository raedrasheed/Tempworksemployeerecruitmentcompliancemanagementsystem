...
Generated: 2026-05-10T14:48:26.680Z
...
| 6 | pilot OFF: legacy reads include tenant B + NULL-tenant legacy row | PASS | total=9 includesB=true includesNull=true |
| 7 | allow-list: TENANT_PRISMA_PILOT_MODULES=nothing ⇒ legacy union (compliance opt-out) | PASS | total=9 includesB=true |