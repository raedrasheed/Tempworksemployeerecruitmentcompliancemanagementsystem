...
Generated: 2026-05-10T06:21:58.140Z
...
| # | Case | Result | Detail |
|--:|------|:------:|--------|
| 1 | pilot ON, tenant A: findAll returns ONLY tenant A rows | PASS | count=2 noB=true |
...
| 5 | concurrent ALS frames isolated (T_A no B-rows; T_B no A-rows) | PASS | aCount=2 bCount=2 aNoB=true bNoA=true |
| 6 | pilot OFF: legacy reads include both tenant A and tenant B records | PASS | count=4 hasA=true hasB=true |
