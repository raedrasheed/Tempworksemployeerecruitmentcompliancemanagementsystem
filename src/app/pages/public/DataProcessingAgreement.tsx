    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 py-12 px-6">
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm border p-8 md:p-10 font-serif text-sm leading-relaxed text-gray-900">
          ...
          <p className="mb-3 ms-4">5.1. By closing working contracts and by granting consent with processing personal data according to Art. 5 this one document provides employee to the employer consent with processing personal data for the following purposes:</p>
