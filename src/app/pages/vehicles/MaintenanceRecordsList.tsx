...
import {
  Plus, Wrench, Pencil, Trash2, ArrowLeft, RefreshCw, Search, Filter, Download,
} from 'lucide-react';
          ...
          <Table>
            ...
            <TableBody>
              {loading ? (
                ...
                <TableRow key={rec.id} className="cursor-pointer" onClick={() => navigate(`/dashboard/vehicles/${rec.vehicleId}`)}>
                  <TableCell>
